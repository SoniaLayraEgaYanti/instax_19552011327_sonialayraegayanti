...
class ChoralPage extends StatefulWidget {
  @override
  _ChoralPage createState() => _ChoralPage();
}

class _ChoralPage extends State<ChoralPage> {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          Column(children: [
          Text("Instax Mini Choral 7+", style: TextStyle(fontSize: 20,color: Colors.redAccent, fontWeight: FontWeight.bold),),
          ...
          child: Text(" \$ 51.90                         ", style: TextStyle(fontSize: 20,color: Colors.black, fontWeight: FontWeight.bold)),         
          ),
