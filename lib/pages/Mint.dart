...
class MintPage extends StatefulWidget {
  @override
  _MintPage createState() => _MintPage();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          Column(children: [
          Text("Instax Mini Mint 7+", style: TextStyle(fontSize: 20,color: Colors.teal, fontWeight: FontWeight.bold),),
          ...
          child: Text(" \$ 49.90                         ", style: TextStyle(fontSize: 20,color: Colors.black, fontWeight: FontWeight.bold)),          
          ),
