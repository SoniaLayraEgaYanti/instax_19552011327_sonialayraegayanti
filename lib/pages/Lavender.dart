...
class LavenderPage extends StatefulWidget {
  @override
  _LavenderPage createState() => _LavenderPage();
}

class _LavenderPage extends State<LavenderPage> {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          Column(children: [
          Text("Instax Mini Lavender 7+", style: TextStyle(fontSize: 20,color: Colors.purple, fontWeight: FontWeight.bold),),
          ...
          child: Text(" \$ 53.90                         ", style: TextStyle(fontSize: 20,color: Colors.black, fontWeight: FontWeight.bold)),          
          ),
