    ...
    return Scaffold(
       ...
       body: Center(
        child: Column(
          ...
          Column(children: [
          Text("Instax Mini Blue 7+", style: TextStyle(fontSize: 20,color: Colors.blue, fontWeight: FontWeight.bold),),
          ...
          child: Text(" \$ 50.90                         ", style: TextStyle(fontSize: 20,color: Colors.black, fontWeight: FontWeight.bold)),          
          ),
